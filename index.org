...
# title slide
* Fullscreen: Title slide "The Value of Learning." :noexport:
*  
:PROPERTIES:
...
:END:
 ...
 This talk is a conversation about learning in the age of information.
...
# Before+after(3)
** Three slides of before+after Betty Edwards's students's drawings. :noexport:
**  
:PROPERTIES:
:reveal_extra_attr: data-state="hide-video" video-size="normal"
:reveal_background_size: 100%
...
:END:
 ...
 How does Betty Edwards

 (NEXT FRAG) facilitate such efficient progress for *all* of her students, not just some?
...
* Fullscreen: Webcam, Jay introduces the talk.                     :noexport:
* 
 :PROPERTIES:
 :reveal_extra_attr: data-state="hide-video"
 :reveal_background_size: 100%
...
- The Answer
- The Action
# Isaac says: These are very abstract. What about swapping for a more concrete exemplification of each?
# Perhaps something like
# - What good is a reconsideration of the value of learning?
# - How might I come to understand my own value of learning?
# - In which ways might I attend to those values?
#
# ... or more succinctly and perhaps more congruent:
# - What is the value of learning?
...
In Germany, Japan and other countries with high technical performance, students are challenged to think through the problem, after being reminded of recent supportive lessons.
...
Educators call this 'productive struggle', and at its heart it's a prime example of "Inside Out" learning.
