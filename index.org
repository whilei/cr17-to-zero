...
** My Credentials
   ...
   As someone whose interested in the mysteries of the brain, our human potential, and the value of learning.

   Brain science is a young science, and the pace of discovery is breathtaking.   
   
   Fortunately, I have a long and

   (NEXT FRAG) documented history of putting my foot in my mouth, just in case you happen to be an actual neuroscientist.

   I'm not an expert in programming, nor in the subject of learning.
   ...
   I've experienced so many wonderful moments like that while researching this talk, thanks to all the people that have opened up about their own learning experiences.

   My hope is that by opening up and sharing my experiences in a candid way, that other people might identify with my triumphs and struggles and that, together, we might be able find a better way of tackling some of our common problems around learning and teaching technical subjects.
...
All told, this is a story about success, about failure, about learning.
