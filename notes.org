...
** TODO add background png (blue/red w/ before and after centered in each)
#+BEGIN_NOTES
These before and after self-portraits were drawn by the same person. How long do you think it took to acquire this improvement in skill? (next slide)
#+END_NOTES
...
** TODO add background png
#+BEGIN_NOTES
How much time for this degree of improvement? (wait 5 seconds) (next slide)
#+END_NOTES
...
#+BEGIN_NOTES
5 days. That's it. These people, people like you or me, learned the technical fundamentals of drawing in only *5 days*. Personally, I was astonished when I first saw these drawings.

How does their teacher, Betty Edwards, facilitate such progress for *all* of her students, not just some?

And how is her approach relevant to learning other highly technical skills, such as programming?

We'll explore this question, and several others, together, over the next hour. (next slide)
#+END_NOTES

#+BEGIN_NOTES
TODO jay add qr code/link tweet here "Betty Edwards, your teaching method is astonishing! #thevalueoflearning .@DRSB_Edwards"
